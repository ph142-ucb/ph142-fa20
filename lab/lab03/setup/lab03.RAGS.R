...
check_problem1 = function() {
  ...
  checkpoint(checkpoint_number = 5,
             ...
             correct_message = "You defined a scatterplot!",
...
check_problem3 = function() {
  ...
  checkpoint(checkpoint_number = 3,
             ...
             correct_message = "You plotted the right variable!",
             error_message = "Did you plot the right variable?")
  
  checkpoint(checkpoint_number = 4,
             test = quo_get_expr(p3$mapping$y) == "log_CS",
             correct_message = "You've plotted the right variable!",
             error_message = "You plotted the right variable?")
  
  checkpoint(checkpoint_number = 5,
             test = "GeomPoint" %in% class(p3$layers[[1]]$geom), 
             correct_message = "You correctly defined a scatter ggplot!",
             error_message = "Did you define a scatterplot in ggplot?")
...
check_problem4 = function() {
  ...
  checkpoint(checkpoint_number = 2,
             ...
             correct_message = "You used the correct dataset!",
             error_message = "Did you use the right dataset?")
  
  checkpoint(checkpoint_number = 3,
             test = quo_get_expr(p4$mapping$x) == "log_GDP",
             correct_message = "You plotted the correct variable!",
             error_message = "Did you plot the right variable?")
  ...
  checkpoint(checkpoint_number = 5,
             ...
             correct_message = "You've defined a scatterplot in ggplot!",
             error_message = "Did you define a scatterplot in ggplot?")
  
  checkpoint(checkpoint_number = 6,
             test = "GeomSmooth" %in% class(p4$layers[[2]]$geom), 
             correct_message = "You've defined a geom_smooth in ggplot!",
...
check_problem5 = function() {
  ...
  checkpoint(checkpoint_number = 5,
             ...
             correct_message = "You've defined a scatterplot!",
             error_message = "Did you define a scatterplot in ggplot?")
  ...
  checkpoint(checkpoint_number = 7,
             ...
             correct_message = "You've set the plot to color by Income_Group!",
...
check_problem6 = function() {
  ...
  checkpoint(checkpoint_number = 1,
             ...
             correct_message = "You've named your new dataset correctly!",
             error_message = "Did you name your new data set CS_data_sub?")
  
  checkpoint(checkpoint_number = 2,
             test = "Low income" %in% CS_data_sub$Income_Group,
             correct_message = "You've filtered Low income Group correctly!",
             error_message = "Did you filter Income_Group correctly?")
  
  checkpoint(checkpoint_number = 3,
             test = "Lower middle income" %in% CS_data_sub$Income_Group,
             correct_message = "You've filtered Lower middle income Group correctly!",
             error_message = "Did you filter Lower middle income Group correctly?")
  
  checkpoint(checkpoint_number = 4,
             test = "Upper middle income" %in% CS_data_sub$Income_Group,
             correct_message = "You've filtered Upper middle income Group correctly!",
             error_message = "Did you filter Upper middle income Group correctly?")
  
  checkpoint(checkpoint_number = 5,
             test = !("High income: nonOECD" %in% CS_data_sub$Income_Group),
             correct_message = "You've excluded High income: nonOECD group correctly!",
             error_message = "Did you filter High income: nonOECD group correctly?")
  
  checkpoint(checkpoint_number = 6,
             test = !("High income: OECD" %in% CS_data_sub$Income_Group),
             correct_message = "You've excluded High income: OECD group correctly!",
             error_message = "Did you filter High income: OECD group correctly?")
...
check_problem8 = function() {
  ...
  checkpoint(checkpoint_number = 1,
             ...
             correct_message = "You've chosen the correct variable for the model!",
             error_message = "Please choose the correct variable for the model.")
