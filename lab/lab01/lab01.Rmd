...
### Instructions 
* Due date: Friday, August 28 at 11:59pm PST.
...
**Pane 1. Console (bottom left pane)** This is where you input code to be processed immediately.
...
This class will use an autograder to help us through labs and homeworks. Basically, we've written a series of test cases and checkpoints that test the correctness of your code and allows you to check your work and receive automated real-time feedback on your answers. 
...
To fixing this dumb bug... hopefully this will work... also hello to everyone who noticed these changes!
...
When your lab is graded, it'll be released on Gradescope and you'll be able to see your code online, as well as the score for each autograded problem.


We know we're also not perfect, and sometimes we mess up the test cases on the autograder, so a correct answer might get graded as incorrect (we hope this is rare), so we highly encourage you to check your assignment promptly after grades are released to make sure you get the score you earned. If you suspect the autograder might be incorrect, you can submit a regrade on Piazza on the appropriate assignment thread. Per the regrade policy, **all assignment regrades will be open for 3 school days after score release** (scores released anytime September 15 means regrades close September 18 night, 11:59pm).

Homework assignments will not be graded. We will release the assignments on Fridays (for the most part) and release solution the following Tuesday. 
...
cd; cd ph142-fa20/lab/lab01; python3 turn_in.py
