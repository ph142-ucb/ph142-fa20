...
#Lab101B: my_key <- "1bWatXMlpJLvOR0ch4Hox-5kMHcsit-32nAuPXhYgXMI"
#Lab102B: my_key <- "1V8TtSV6uv7prZIYcGQTn9QQ482IajVYLX6E4LZjwfRw"
#Lab103B: my_key <- "1diY17Q78CVczyLFOSwlySRwF0Ef9T96o8IYO6lHEjPA"
#Lab104B: my_key <- "1gVGxDOPrlk3jvKtI5raezOj17WF1IhJaxt3gs1KR4Ds"
#Lab105B: my_key <- "1sYpg1MkTcIR2ViHdQZrtVJ7_oR5OUwVJT-f_LwmBjQo"
#Lab106B: my_key <- "1TMpkxrOXvfp7-u6KxnQiIRFvUuIdrFDNDl6hHwSqtS0"
#Lab107B: my_key <- "15V6qR37-pPW0t3DAAuH_ElyqToTBgtFp0DYLu3iR0Og"
#Lab108B: my_key <- "1TFQYLia1HG1GA6hPGy1WwoFYS-qav5fvcbshwrqD7zs"
#Lab109B: my_key <- "1Axn4186utxbIUGcKu_SNp_u2pd7rtTPNsSlv4HTmvps"
#Lab110B: my_key <- "1pwv2WJbpy_oZZT7D5TN0Gb8-vh-sFx5SkK60Fkr51AI"


our_sheet_ss_10 <- my_key %>%
  gs_key(lookup = FALSE) %>% 
  gs_read(range = "A1:F300")
...
```{r sample-size-50}
our_sheet_ss_50 <- my_key %>% 
  gs_key(lookup = FALSE) %>% 
  gs_read("n = 50", range = "A1:F300")
