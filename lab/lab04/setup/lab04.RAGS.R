...
check_problem1 = function() {
  ...
  checkpoint(checkpoint_number = 1,
             test = a == "This event is impossible, it can never occur.",
             correct_message = "Correct, this event is impossiple",
             error_message = "Incorrect, this event should be...")
  
  checkpoint(checkpoint_number = 2,
             test = b == "This event will very rarely occur.",
             correct_message = "Correct, this event will very rarely occur",
             error_message = "Incorrect, this event should be...")
  
  checkpoint(checkpoint_number = 3,
             test = c == "This event is unlikely.",
             correct_message = "Correct, this event is unlikely",
             error_message = "Incorrect, this event should be...")
  
  
  checkpoint(checkpoint_number = 4,
             test = d == "This event will occur more often than not.",
             correct_message = "Correct, this event will occur more often than not",
             error_message = "Incorrect, this event should be...")
  
  checkpoint(checkpoint_number = 5,
             test = e == "This event will almost always occur.",
             correct_message = "Correct, this event will almost always occur",
             error_message = "Incorrect, this event should be...")
  
  checkpoint(checkpoint_number = 6,
             test = f == "This event will always occur.",
             correct_message = "Correct, this event will always occur",
             error_message = "Incorrect, this event should be...")
...
check_problem5 = function() {
  ...
  # Test cases here:
  checkpoint(checkpoint_number = 1,
             test = class(one_hundred_flips_2) == "integer",
             correct_message = "Correct! They are integers",
             error_message = "Not integers")
  
  checkpoint(checkpoint_number = 2,
             test = length(one_hundred_flips_2) == 100,
             correct_message = "Correct! Sample size is 100",
             error_message = "Incorrect sample size")
  
  checkpoint(checkpoint_number = 3,
             test = range(one_hundred_flips_2) == c(0,1),
             correct_message = "Correct! Outputs are values of zero and one, it's binary",
             error_message = "Incorrect, outputs are not binary events")
...
check_problem14 = function() {
  ...
  checkpoint(checkpoint_number = 1,
             test = class(p14) == "numeric" & length(p14) == 1,
             correct_message = "Correct! It's numeric",
             error_message = "Is p14 a numeric value?")
  
  checkpoint(checkpoint_number = 2,
             test = 0 <= p14 & p14 <= 1,
             correct_message = "Correct! It takes value between 0 and 1",
             error_message = "Does your answer take value between 0 and 1?")
  
  checkpoint(checkpoint_number = 3,
             test = p14 == 0.4,
             correct_message = "Correct! p14= 0.4",
...
check_problem15 = function() {
  ...
  checkpoint(checkpoint_number = 1,
             test = class(p15) == "numeric" & length(p15) == 1,
             correct_message = "Correct! It's numeric",
  ...
  checkpoint(checkpoint_number = 2,
             test = 0 <= p15 & p15 <= 1,
             correct_message = "Correct! It takes value between 0 and 1",
             error_message = "Does your answer take value from 0 to 1?")
  
  checkpoint(checkpoint_number = 3,
             test = p15 == 0.4,
             correct_message = "Correct! p15= 0.4",
             error_message = "Did you compute the correct probability?")
...
check_problem16 = function() {
  ...
  checkpoint(checkpoint_number = 1,
             test = class(p16) == "numeric" & length(p16) == 1,
             correct_message = "Correct! It's numeric",
  ...
  checkpoint(checkpoint_number = 3,
             test = p16 == 0.2,
             correct_message = "Correct! p16= 0.2",
             error_message = "Did you compute the correct probability?")
...
check_problem17 = function() {
  ...
  checkpoint(checkpoint_number = 1,
             test = class(p17) == "numeric" & length(p17) == 1,
             correct_message = "Correct! It's numeric",
  ...
  checkpoint(checkpoint_number = 3,
             test = p17 == 0.8,
             correct_message = "Correct! p17= 0.8",
             error_message = "Did you compute the correct probability?")
...
check_problem18 = function() {
  ...
  checkpoint(checkpoint_number = 1,
             test = class(p18) == "numeric" & length(p18) == 1,
             correct_message = "Correct! It's numeric",
             error_message = "Is p18 a numeric value?")
...
check_problem21 = function() {
  ...
  checkpoint(checkpoint_number = 1,
             test = class(p21) == "numeric" & length(p21) == 1,
             correct_message = "Correct! It's numeric",
             error_message = "Is p21 a numeric value?")
  ...
  checkpoint(checkpoint_number = 3,
             test = p21 == 0.2,
             correct_message = "Correct! p21= 0.2",
             error_message = "Did you compute the correct probability?")
...
check_problem22 = function() {
  ...
  checkpoint(checkpoint_number = 1,
             test = class(p22) == "numeric" & length(p22) == 1,
             correct_message = "Correct! It's numeric",
             error_message = "Is p22 a numeric value?")
  ...
  checkpoint(checkpoint_number = 3,
             test = p22 == 0.8,
             correct_message = "Correct! p22= 0.8",
             error_message = "Did you compute the correct probability?")
