...
check_problem3 = function() {
  ...
  checkpoint(checkpoint_number = 1,
             test = all.equal(test_stat, 107.83, tol = 0.1),
             correct_message = "You found the correct test statistics!",
             error_message = "Did you make sure to use the function chisq.test() in problem 3?")
  
  checkpoint(checkpoint_number = 2,
             test = all.equal(p_value, 0, tol = 0.01),
             correct_message = "You found the correct p-value!",
             error_message = "Did you make sure to use the function chisq.test() in problem 3?")  
...
check_problem5 = function() {
  ...
  checkpoint(checkpoint_number = 1,
             test = all.equal(reject_value, 7.814728, tol = 0.01),
             correct_message = "You found the correct reject_value!",
             error_message = "Did you make sure to use the function qchisq() in problem 5?")
...
check_problem8 = function() {
  ...
  checkpoint(checkpoint_number = 1,
             test = is.data.frame(chd_by_anger_level),
             correct_message = "Correct! It is a data frame",
             error_message = "Check the type of chd_by_anger_level")
  
  checkpoint(checkpoint_number = 2,
             test = nrow(chd_by_anger_level) == 6,
             correct_message = "Correct number of rows",
             error_message = "Data frame is of the wrong number of rows")
  
  checkpoint(checkpoint_number = 3,
             test = ncol(chd_by_anger_level) == 6,
             correct_message = "Correct number of columns!",
             error_message = "Data frame is of the wrong number of columns")
...
check_problem9 = function() {
  ...
  checkpoint(checkpoint_number = 2,
             test = nrow(chd_by_anger_level) == 6 && ncol(chd_by_anger_level) == 7,
             correct_message = "Correct number of rows and columns",
             error_message = "Data frame is of the wrong size.")
  
  checkpoint(checkpoint_number = 3,
             test = all.equal(chd_by_anger_level$expected_count[1], 69.73094, tol = 0.01),
             correct_message = "Correct value of expected_count!",
             error_message = "Incorrect value of expected_count.")
...
check_problem11 = function() {
  ...
  checkpoint(checkpoint_number = 2,
             test = nrow(chd_by_anger_level) == 6 && ncol(chd_by_anger_level) == 8,
             correct_message = "Correct number of rows and columns",
             error_message = "Data frame is of the wrong size.")
  
  checkpoint(checkpoint_number = 3,
             test = all.equal(chd_by_anger_level$cond_prop_anger[1], 0.2789474, tol = 0.01),
             correct_message = "Correct value of cond_prop_anger!",
             error_message = "Incorrect value of cond_prop_anger")
...
check_problem12 = function() {
  ...
  checkpoint(checkpoint_number = 1,
             test = "ggplot" %in% class(dodged),
             correct_message = "A ggplot has been defined",
             error_message = "You did not define a ggplot.")
  
  checkpoint(checkpoint_number = 2,
             test = identical(dodged$data, chd_by_anger_level),
             correct_message = "You are using the correct dataset!",
             error_message = "Did you use the right dataset?")
  
  checkpoint(checkpoint_number = 3,
             test = quo_get_expr(dodged$mapping$x) == "anger_level",
             correct_message = "Correct x variable plotted!",
             error_message = "Did you plot the right x variable?")
  
  checkpoint(checkpoint_number = 4,
             test = quo_get_expr(dodged$mapping$y) == "cond_prop_anger",
             correct_message = "Correct y variable plotted!",
             error_message = "Did you plot the right y variable?")
  
  checkpoint(checkpoint_number = 5,
             test = "GeomBar" %in% class(dodged$layers[[1]]$geom), 
             correct_message = "You defined a Bar chart!",
             error_message = "Did you define a Bar chart in ggplot?")
  
  checkpoint(checkpoint_number = 6,
             test = "PositionDodge" %in% class(dodged$layers[[1]]$position), 
             correct_message = "You defined a dodged Bar chart!",
             error_message = "Did you define a dodged Bar chart in ggplot?")
...
check_problem13 = function() {
  ...
  checkpoint(checkpoint_number = 1,
             test = all.equal(chi_square_test_statistic, 16.07676, tol = 0.1),
             correct_message = "Correct chi square test statistics!",
             error_message = "Incorrect chi square test statistics!")
...
check_problem14 = function() {
  ...
  checkpoint(checkpoint_number = 1,
             test = all.equal(chi_sq_p_value, 0.0003228312, tol = 0.001),
             correct_message = "Correct chi square p value!",
             error_message = "Incorrect chi square p value!")
