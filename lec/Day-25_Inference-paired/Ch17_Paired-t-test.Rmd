...
- What is the estimate of the standard error of the mean for each test?
  - To get the answer, rearrange the formula for the test statistic to solve for the SE. You know the value of the test statistic and the numerator of the test statistic from the R output.
