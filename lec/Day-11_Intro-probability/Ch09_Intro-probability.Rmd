...
Video link (2 mins): [click here](https://youtu.be/HHWNO4KgcKw) (need to be in you Berkeley account for the link to work) 

```{r, include = F}
#old video link: https://www.youtube.com/watch?v=nuSqWRuz-mU&feature=youtu.be
```
...
- Last Wednesday, we talked about how larger samples provide better estimates on average.
