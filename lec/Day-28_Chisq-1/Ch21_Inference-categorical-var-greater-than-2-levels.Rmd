...
expectations so that a difference of 100 fewer Latinx jurors  
counts for more than a difference of 100 fewer white jurors compared to what is expected for each group.
...
$H_0: p_1 = 1/7\text{, }p_2=1/7\text{, }p_3=1/7\text{, }p_4 = 1/7\text{, }p_5=1/7\text{, }p_6=1/7\text{, }p_7=1/7\$. 
