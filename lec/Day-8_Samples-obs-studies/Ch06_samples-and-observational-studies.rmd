...
knitr::include_graphics("./images/HBRreviewbias.png")
```

### Statistics is Everywhere
- from *`r link('Harvard Business Review','https://hbr.org/2018/03/online-reviews-are-biased-heres-how-to-fix-them')`*, March 2018:
...
knitr::include_graphics("./images/amazon_small.png")
```
...
knitr::include_graphics("./images/yelp.png")
```


### Statistics is Everywhere
```{r amm, echo=F, out.width = "60%"}
knitr::include_graphics("./images/amazon_medium.png")
```
...
knitr::include_graphics("./images/research-cycle.png")
```
